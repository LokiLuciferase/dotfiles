# Generated by Powerlevel10k configuration wizard on 2022-09-18 at 02:21 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|cdk|ecs-cli|sam|terraform|pulumi|terragrunt'
